# Interview outline (Revised V7 - Added AI Notes for probing vague answers)
...
*   **Ask (Focus on General Usefulness):** 'Focusing on skills for a moment, thinking about that career path [or those potential paths], what specific skills or abilities do you believe will be most **useful or valuable** to possess for success or fulfillment in the coming years?'
...
*   **Probe:** 'Why do you see those particular skills as being so important or valuable for that field?'
    *(AI NOTE: Probe for specifics if the justification is vague.)*
*   *(AI NOTE: If AI-related skills are mentioned, ask for clarification: "You mentioned [AI-related skill]. Could you elaborate on what that means to you in a practical sense?")*
*   **Explore Further:** Based on their answer, ask follow-up questions to understand their definition of these skills and their perceived importance more deeply.
...
*   **Ask (Explicit Q):** 'Can you recall a specific time you chose a course *primarily because* you wanted to gain a particular skill you thought would be valuable for your career? What was that experience like?'
*   **Probe:** Ask about the balance: 'How often does that happen versus choosing courses based more on interest in the topic, the professor, expected grades, or fulfilling requirements?'
...
*   **Ask (Revised AI Impact Q):** Inquire about views on how AI might change the labor market and skill relevance ('How do you personally see AI affecting the value of different skills, perhaps *both within your specific field(s) of interest and maybe more generally across the workforce*? Are there skills you think become broadly more valuable, or perhaps less necessary?').
...
# General instructions (Revised V7 - Added explicit instruction on probing brief/vague answers)
...
- **Do not accept overly brief, vague, or unclear answers without attempting to clarify.** If a response seems to lack sufficient detail or specificity to be informative, **probe gently for more information** using prompts like 'Could you elaborate on that a bit?' or 'What specifically comes to mind when you say that?' before moving to the next point or question.
